...
<div class="row align-items-center">
    <div class="col">
<a href="index.php?action=newadvert" class="btn blue btn-md my-4 white-text"><i class="fas fa-plus"></i> Ajouter une annonce</a></div>
<div class="col  text-right"><ul class="pagination no-gutters mt-3">

    <?php for ($i = 0; $i < $lastPage; $i++) : ?>
        <li class="page-item <?= $i + 1 == $currentPage ? "active" : '' ?>">
            <a class="page-link" aria-current="page" href="index.php?action=indexadminallestates&page=<?= $i + 1 ?>"><?= $i + 1 ?></a>
        </li>
    <?php endfor; ?>
