...
<form action="index.php?action=modifyestate&id=<?= $estate['id'] ?>" method="post" enctype="multipart/form-data" id="modifyestate" novalidate>
  ...
  <div class="text-center">
    <button class="blue  my-4 btn-lg  text-lg font-weight-bold black-text" type="submit" value="1" name="modifyadvertpublish" id="modifyadvertpublish">Publier l'annonce</button>
    <button class="blue my-4 btn-lg  text-lg font-weight-bold black-text" type="submit" value="2" name="modifydvertnopublish" id="modifyadvertnopublish">Ne pas publier l'annonce</button>
