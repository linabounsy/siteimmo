...
<div class="pt-4">
<a href="index.php?action=displayclient&client.php" class="btn blue btn-md my-4">Revenir à la page précédente</a>


<!-- Material form register -->
<div class="card">

    <h5 class="card-header blue black-text text-center py-4">
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <form class="text-center" action="index.php?action=insertnewclient" method="post">
            ...
            <!-- Sign up button -->
            <button class="btn btn-outline-info blue btn-rounded btn-block my-4 waves-effect z-depth-0 w-50 m-auto" type="submit">Validez</button>
