...
! function(t) {
    ...
    if (o) {
        ...
        setFloat64: function(t, e) {
            _(this, 8, t, D, e, arguments.length > 2 ? arguments[2] : void 0)
        }
    });
                                ...
                                if ("scroll" === T) {
                                    ...
                                    for (var I in a(o).tweensContainer && !0 === a(o).isAnimating && (P = a(o).tweensContainer), f.each(y, (function(t, e) {
                                        ...
                                        if (a(o).isSVG || "tween" === _ || !1 !== x.Names.prefixCheck(_)[1] || x.Normalizations.registered[_] !== r) {
                                            (s.display !== r && null !== s.display && "none" !== s.display || s.visibility !== r && "hidden" !== s.visibility) && /opacity|filter/.test(I) && !H && 0 !== D && (H = 0), s._cacheValues && P && P[I] ? (H === r && (H = P[I].endValue + P[I].unitType), B = a(o).rootPropertyValueCache[_]) : x.Hooks.registered[I] ? H === r ? (B = x.getPropertyValue(o, _), H = x.getPropertyValue(o, I, B)) : B = x.Hooks.templates[_][1] : H === r && (H = x.getPropertyValue(o, I));
                                            var N, F, Y, X = !1;
                                            if (H = (N = h(I, H))[0], Y = N[1], D = (N = h(I, D))[0].replace(/^([+-\/*])=/, (function(t, e) {
                                                    return X = e, ""
                                                })), F = N[1], H = parseFloat(H) || 0, D = parseFloat(D) || 0, "%" === F && (/^(fontSize|lineHeight)$/.test(I) ? (D /= 100, F = "em") : /^scale/.test(I) ? (D /= 100, F = "") : /(Red|Green|Blue)$/i.test(I) && (D = D / 100 * 255, F = "")), /[\/*]/.test(X)) F = Y;
                                            else if (Y !== F && 0 !== H)
                                                if (0 === D) F = Y;
                                                else {
                                                    i = i || p();
    ...
    o ? (j || (O.f = z, $.f = q, F(H, "buffer"), F(H, "byteOffset"), F(H, "byteLength"), F(H, "length")), i({
        target: "Object",
        stat: !0,
        forced: !j
    }, {
        ...
        })), w && w(g, V), m = g.prototype = b(H)), m.constructor !== g && d(m, "constructor", g), D && d(m, D, s), $[s] = g, i({
            global: !0,
            forced: g != v,
            sham: !j
    ...
    (function(t) {
        ...
        }, "object" === ("undefined" == typeof exports ? "undefined" : r(exports)) && void 0 !== t ? t.exports = i() : "function" == typeof define && n(83) ? define(i) : (e = e || self).PerfectScrollbar = i()
    }).call(this, n(96)(t))
}, function(t, e, n) {
    "use strict";
    var i = n(4),
