...
<form action="index.php?action=newadvert" method="post" enctype="multipart/form-data" novalidate>
        ...
        <div class="card-body text-center">
          <div class="list-group list-group-flush">
            ...
            <div class="list-group-item justify-content-between p-0">
              ...
              <div class="card-body text-left p-0">
                <div class="md-form mt-2">
                  <input type="text" class="form-control datepicker-periode" placeholder="Choisissez une date" id="periode" name="periode" value="<?= (!empty($_POST['periode'])) ? $_POST['periode'] : null ?>">
  ...
  <div class="text-center">
    <button class="blue  my-4 btn-lg  text-lg font-weight-bold white-text" value="1" name="newadvertpublish" id="newadvertpublish">Publier l'annonce</button>
    <button class="blue my-4 btn-lg  text-lg font-weight-bold white-text" value="2" name="newadvertnopublish" id="newadvertnopublish">Ne pas publier l'annonce</button>
