...
<section class="dark-grey-text">
    ...
    <?php foreach ($listEstates as $listEstate) { ?>
        ...
        <div class="card card-cascade allestates">

            <!-- Card image -->

            <img class="img-admin" src="img/estates/<?= $listEstate['picture'] ?>" alt="Card image cap">
            ...
            <div class="row mt-4 mb-4">
                <div class="col-lg-6 mb-lg-0 mb-6 ml-5 ">
                    ...
                    <ul class="list-unstyled fa-ul mb-0 details">
