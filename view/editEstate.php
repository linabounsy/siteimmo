...
<form action="index.php?action=modifyestate&id=<?= $estate['id'] ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body text-center">
                <div class="list-group list-group-flush">
                    ...
                    <div class="justify-content-between p-0">
                        ...
                        <div class="card-body text-left p-0">
                            <div class="md-form mt-2">
                                <input type="text" class="form-control datepicker" placeholder="Choisissez une date" id="construction" name="construction" value="<?= date_format(date_create($estate['construction']), 'Y') ?>">
                    ...
                    <div class="list-group-item justify-content-between p-0">
                        ...
                        <div class="card-body text-left p-0">
                            <div class="md-form mt-2">
                                <input type="text" class="form-control datepicker-periode" placeholder="Choisissez une date" id="periode" name="periode" value="<?= date_format(date_create($estate['periode']), 'd-m-Y') ?>">
                    ...
                    <div class="justify-content-between p-0">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="control-inline text-left p-0">
                                ...
                                <img src="img/estates/<?= $estate["picture"] ?>" id="editestateimg" class="card-img-top w-25" alt="image appart">
